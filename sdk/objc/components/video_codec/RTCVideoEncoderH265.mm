...
CFStringRef ExtractProfile(const webrtc::H265ProfileTierLevel &profile_level_id) {
    switch (profile_level_id.profile) {
        case webrtc::H265Profile::kProfileMain:
        case webrtc::H265Profile::kProfileMain10:
        case webrtc::H265Profile::kProfileMainStill:
        case webrtc::H265Profile::kProfileRangeExtensions:
        case webrtc::H265Profile::kProfileHighThroughput:
        case webrtc::H265Profile::kProfileMultiviewMain:
        case webrtc::H265Profile::kProfileScalableMain:
        case webrtc::H265Profile::kProfile3dMain:
        case webrtc::H265Profile::kProfileScreenContentCoding:
        case webrtc::H265Profile::kProfileScalableRangeExtensions:
        case webrtc::H265Profile::kProfileHighThroughputScreenContentCoding:
            switch (profile_level_id.level) {
                case webrtc::H265Level::kLevel1:
                case webrtc::H265Level::kLevel2:
                case webrtc::H265Level::kLevel2_1:
                case webrtc::H265Level::kLevel3:
                case webrtc::H265Level::kLevel3_1:
                case webrtc::H265Level::kLevel4:
                case webrtc::H265Level::kLevel4_1:
                case webrtc::H265Level::kLevel5:
                case webrtc::H265Level::kLevel5_1:
                case webrtc::H265Level::kLevel5_2:
                case webrtc::H265Level::kLevel6:
                case webrtc::H265Level::kLevel6_1:
                case webrtc::H265Level::kLevel6_2:
...
// for details.
NSUInteger GetMaxSampleRate(const webrtc::H265ProfileTierLevel &profile_level_id) {
    switch (profile_level_id.level) {
        case webrtc::H265Level::kLevel1:
        case webrtc::H265Level::kLevel2:
        case webrtc::H265Level::kLevel2_1:
...
@implementation RTC_OBJC_TYPE (RTCVideoEncoderH265) {
  ...
  RTCH265PacketizationMode _packetizationMode;
  absl::optional<webrtc::H265ProfileTierLevel> _profile_level_id;
...
- (instancetype)initWithCodecInfo:(RTC_OBJC_TYPE(RTCVideoCodecInfo) *)codecInfo {
  if (self = [super init]) {
    ...
    _packetizationMode = RTCH265PacketizationModeNonInterleaved;
    _profile_level_id =
        webrtc::ParseSdpForH265ProfileTierLevel([codecInfo nativeSdpVideoFormat].parameters);
...
- (void)configureCompressionSession {
  ...
  SetVTSessionProperty(_compressionSession, kVTCompressionPropertyKey_AllowOpenGOP, false);
...
- (void)frameWasEncoded:(OSStatus)status
  ...
  if (status != noErr) {
    RTC_LOG(LS_ERROR) << "H265 encode failed with code: " << status;
    return;
  }
